...
(deftest core-test
  ...
  (testing "chord->scales"
    (are+ [pitch chord-name expected] (= (set expected) (set (map #(select-keys % [:pitch :name :context])
      ...
      :C :maj [{:pitch :C, :name :major, :context :chord-degree/I}
               ...
               {:pitch :C, :name :lydian-dominant-pentatonic, :context :chord-degree/I}
      ...
      :Eb :6add9 [{:pitch :C, :name :minor, :context :chord-degree/bIII6add9}
                  {:pitch :C, :name :minor-blues, :context :chord-degree/bIII6add9}
                  {:pitch :C, :name :dorian, :context :chord-degree/bIII6add9}
                  {:pitch :C, :name :phrygian, :context :chord-degree/bIII6add9}
                  {:pitch :C, :name :minor-pentatonic, :context :chord-degree/bIII6add9}
                  {:pitch :C, :name :dorian-b2, :context :chord-degree/bIII6add9}
                  {:pitch :C, :name :spanish-heptatonic, :context :chord-degree/bIII6add9}
                  {:pitch :C, :name :bebop-minor, :context :chord-degree/bIII6add9}
                  {:pitch :C, :name :bebop-locrian, :context :chord-degree/bIII6add9}
                  {:pitch :C, :name :bebop-harmonic-minor, :context :chord-degree/bIII6add9}
                  {:pitch :C, :name :composite-blues, :context :chord-degree/bIII6add9}
                  {:pitch :Db, :name :lydian, :context :chord-degree/II6add9}
                  {:pitch :Db, :name :lydian-augmented, :context :chord-degree/II6add9}
                  {:pitch :D, :name :phrygian, :context :chord-degree/bII6add9}
                  {:pitch :D, :name :locrian, :context :chord-degree/bII6add9}
                  {:pitch :D, :name :spanish-heptatonic, :context :chord-degree/bII6add9}
                  {:pitch :D, :name :bebop-locrian, :context :chord-degree/bII6add9}
                  {:pitch :Eb, :name :major, :context :chord-degree/I6add9}
                  {:pitch :Eb, :name :major-pentatonic, :context :chord-degree/I6add9}
                  {:pitch :Eb, :name :major-blues, :context :chord-degree/I6add9}
                  {:pitch :Eb, :name :bebop, :context :chord-degree/I6add9}
                  {:pitch :Eb, :name :lydian, :context :chord-degree/I6add9}
                  {:pitch :Eb, :name :mixolydian, :context :chord-degree/I6add9}
                  {:pitch :Eb, :name :lydian-dominant, :context :chord-degree/I6add9}
                  {:pitch :Eb, :name :bebop-minor, :context :chord-degree/I6add9}
                  {:pitch :Eb, :name :bebop-major, :context :chord-degree/I6add9}
                  {:pitch :Eb, :name :composite-blues, :context :chord-degree/I6add9}
                  {:pitch :F, :name :minor, :context :chord-degree/bVII6add9}
                  {:pitch :F, :name :bebop, :context :chord-degree/bVII6add9}
                  {:pitch :F, :name :dorian, :context :chord-degree/bVII6add9}
                  {:pitch :F, :name :mixolydian, :context :chord-degree/bVII6add9}
                  {:pitch :F, :name :mixolydian-b6, :context :chord-degree/bVII6add9}
                  {:pitch :F, :name :bebop-minor, :context :chord-degree/bVII6add9}
                  {:pitch :F, :name :bebop-harmonic-minor, :context :chord-degree/bVII6add9}
                  {:pitch :F, :name :composite-blues, :context :chord-degree/bVII6add9}
                  {:pitch :G, :name :minor, :context :chord-degree/bVI6add9}
                  {:pitch :G, :name :phrygian, :context :chord-degree/bVI6add9}
                  {:pitch :G, :name :locrian, :context :chord-degree/bVI6add9}
                  {:pitch :G, :name :locrian-#2, :context :chord-degree/bVI6add9}
                  {:pitch :G, :name :spanish-heptatonic, :context :chord-degree/bVI6add9}
                  {:pitch :G, :name :bebop-locrian, :context :chord-degree/bVI6add9}
                  {:pitch :G, :name :bebop-harmonic-minor, :context :chord-degree/bVI6add9}
                  {:pitch :Ab, :name :major, :context :chord-degree/V6add9}
                  {:pitch :Ab, :name :bebop, :context :chord-degree/V6add9}
                  {:pitch :Ab, :name :lydian, :context :chord-degree/V6add9}
                  {:pitch :Ab, :name :bebop-major, :context :chord-degree/V6add9}
                  {:pitch :A, :name :locrian, :context :chord-degree/bV6add9}
                  {:pitch :A, :name :altered, :context :chord-degree/#IV6add9}
                  {:pitch :A, :name :bebop-locrian, :context :chord-degree/bV6add9}
                  {:pitch :Bb, :name :major, :context :chord-degree/IV6add9}
                  {:pitch :Bb, :name :melodic-minor, :context :chord-degree/IV6add9}
                  {:pitch :Bb, :name :bebop, :context :chord-degree/IV6add9}
                  {:pitch :Bb, :name :dorian, :context :chord-degree/IV6add9}
                  {:pitch :Bb, :name :mixolydian, :context :chord-degree/IV6add9}
                  {:pitch :Bb, :name :bebop-minor, :context :chord-degree/IV6add9}
                  {:pitch :Bb, :name :bebop-major, :context :chord-degree/IV6add9}
                  {:pitch :Bb, :name :minor-six-diminished, :context :chord-degree/IV6add9}
                  {:pitch :Bb, :name :composite-blues, :context :chord-degree/IV6add9}]

      :C :13sus4 [{:pitch :C, :name :bebop, :context :chord-degree/i13sus4}
                  {:pitch :C, :name :dorian, :context :chord-degree/i13sus4}
                  {:pitch :C, :name :mixolydian, :context :chord-degree/i13sus4}
                  {:pitch :C, :name :bebop-minor, :context :chord-degree/i13sus4}
                  {:pitch :C, :name :composite-blues, :context :chord-degree/i13sus4}
                  {:pitch :D, :name :minor, :context :chord-degree/bvii13sus4}
                  {:pitch :D, :name :phrygian, :context :chord-degree/bvii13sus4}
                  {:pitch :D, :name :spanish-heptatonic, :context :chord-degree/bvii13sus4}
                  {:pitch :D, :name :bebop-locrian, :context :chord-degree/bvii13sus4}
                  {:pitch :D, :name :bebop-harmonic-minor, :context :chord-degree/bvii13sus4}
                  {:pitch :Eb, :name :lydian, :context :chord-degree/vi13sus4}
                  {:pitch :E, :name :locrian, :context :chord-degree/bvi13sus4}
                  {:pitch :E, :name :bebop-locrian, :context :chord-degree/bvi13sus4}
                  {:pitch :F, :name :major, :context :chord-degree/v13sus4}
                  {:pitch :F, :name :bebop, :context :chord-degree/v13sus4}
                  {:pitch :F, :name :mixolydian, :context :chord-degree/v13sus4}
                  {:pitch :F, :name :bebop-minor, :context :chord-degree/v13sus4}
                  {:pitch :F, :name :bebop-major, :context :chord-degree/v13sus4}
                  {:pitch :F, :name :composite-blues, :context :chord-degree/v13sus4}
                  {:pitch :G, :name :minor, :context :chord-degree/iv13sus4}
                  {:pitch :G, :name :dorian, :context :chord-degree/iv13sus4}
                  {:pitch :G, :name :bebop-minor, :context :chord-degree/iv13sus4}
                  {:pitch :G, :name :bebop-harmonic-minor, :context :chord-degree/iv13sus4}
                  {:pitch :G, :name :composite-blues, :context :chord-degree/iv13sus4}
                  {:pitch :A, :name :phrygian, :context :chord-degree/biii13sus4}
                  {:pitch :A, :name :locrian, :context :chord-degree/biii13sus4}
                  {:pitch :A, :name :spanish-heptatonic, :context :chord-degree/biii13sus4}
                  {:pitch :A, :name :bebop-locrian, :context :chord-degree/biii13sus4}
                  {:pitch :Bb, :name :major, :context :chord-degree/ii13sus4}
                  {:pitch :Bb, :name :bebop, :context :chord-degree/ii13sus4}
                  {:pitch :Bb, :name :lydian, :context :chord-degree/ii13sus4}
